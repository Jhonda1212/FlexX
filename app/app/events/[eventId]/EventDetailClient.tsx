...
import { ArrowLeft, CalendarDays, ExternalLink, Loader2, MapPin, Music, Ticket, Users } from "lucide-react";
      ...
      <FlexCard className="overflow-hidden p-0">
        <div className="relative min-h-[420px] p-5 sm:p-8">
          ...
          <div className="relative z-10 flex min-h-[360px] max-w-3xl flex-col justify-end">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--gold)]">Proximo evento</p>
          ...
          {ticketTiers.length ? (
            <div className="space-y-3">
              {ticketTiers.map((tier) => {
                ...
                return (
                  <div key={tier.id} className="rounded-lg border border-white/10 bg-white/[0.035] p-4">
            ...
            <div className="rounded-lg border border-white/10 bg-white/[0.03] p-4">
              <p className="font-bold text-white">{minimumTicketPriceLabel([], event.ticketPriceCents)}</p>
